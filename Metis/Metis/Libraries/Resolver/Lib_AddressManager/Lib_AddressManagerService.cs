...
namespace Metis.Libraries.Resolver.Lib_AddressManager
{
    ...
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, Lib_AddressManagerDeployment lib_AddressManagerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, Lib_AddressManagerDeployment lib_AddressManagerDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<Lib_AddressManagerDeployment>().SendRequestAsync(lib_AddressManagerDeployment);
        }

        public static async Task<Lib_AddressManagerService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, Lib_AddressManagerDeployment lib_AddressManagerDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public Lib_AddressManagerService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
