...
using Metis.OVM.Predeploys.OVM_DeployerWhitelist.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Predeploys.OVM_DeployerWhitelist;

public class OVM_DeployerWhitelistService
{
    public OVM_DeployerWhitelistService(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3,
        OVM_DeployerWhitelistDeployment oVM_DeployerWhitelistDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_DeployerWhitelistDeployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_DeployerWhitelistDeployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_DeployerWhitelistDeployment oVM_DeployerWhitelistDeployment)
    {
    ...
    public static async Task<OVM_DeployerWhitelistService> DeployContractAndGetServiceAsync(Web3 web3,
        OVM_DeployerWhitelistDeployment oVM_DeployerWhitelistDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
    ...
    public Task<string> EnableArbitraryContractDeploymentRequestAsync(
        EnableArbitraryContractDeploymentFunction enableArbitraryContractDeploymentFunction)
    {
    ...
    public Task<TransactionReceipt> EnableArbitraryContractDeploymentRequestAndWaitForReceiptAsync(
        EnableArbitraryContractDeploymentFunction enableArbitraryContractDeploymentFunction, CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> GetOwnerRequestAndWaitForReceiptAsync(GetOwnerFunction getOwnerFunction,
    ...
    public Task<TransactionReceipt> InitializeRequestAndWaitForReceiptAsync(InitializeFunction initializeFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> InitializeRequestAndWaitForReceiptAsync(string owner, bool allowArbitraryDeployment,
        CancellationTokenSource cancellationToken = null)
    {
        var initializeFunction = new InitializeFunction();
        initializeFunction.Owner = owner;
    ...
    public Task<TransactionReceipt> IsDeployerAllowedRequestAndWaitForReceiptAsync(IsDeployerAllowedFunction isDeployerAllowedFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> SetAllowArbitraryDeploymentRequestAndWaitForReceiptAsync(
        SetAllowArbitraryDeploymentFunction setAllowArbitraryDeploymentFunction, CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> SetAllowArbitraryDeploymentRequestAndWaitForReceiptAsync(bool allowArbitraryDeployment,
        CancellationTokenSource cancellationToken = null)
    {
        var setAllowArbitraryDeploymentFunction = new SetAllowArbitraryDeploymentFunction();
        setAllowArbitraryDeploymentFunction.AllowArbitraryDeployment = allowArbitraryDeployment;
    ...
    public Task<TransactionReceipt> SetOwnerRequestAndWaitForReceiptAsync(SetOwnerFunction setOwnerFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> SetWhitelistedDeployerRequestAndWaitForReceiptAsync(SetWhitelistedDeployerFunction setWhitelistedDeployerFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> SetWhitelistedDeployerRequestAndWaitForReceiptAsync(string deployer, bool isWhitelisted,
        CancellationTokenSource cancellationToken = null)
    {
        var setWhitelistedDeployerFunction = new SetWhitelistedDeployerFunction();
        setWhitelistedDeployerFunction.Deployer = deployer;
