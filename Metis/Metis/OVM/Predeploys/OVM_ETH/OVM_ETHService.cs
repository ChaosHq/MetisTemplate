...
{
    public partial class OVM_ETHService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, OVM_ETHDeployment oVM_ETHDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<OVM_ETHDeployment>().SendRequestAndWaitForReceiptAsync(oVM_ETHDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, OVM_ETHDeployment oVM_ETHDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<OVM_ETHDeployment>().SendRequestAsync(oVM_ETHDeployment);
        }

        public static async Task<OVM_ETHService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, OVM_ETHDeployment oVM_ETHDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public OVM_ETHService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
