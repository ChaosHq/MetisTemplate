...
using Metis.OVM.Predeploys.OVM_ETH.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Predeploys.OVM_ETH;

public class OVM_ETHService
{
    public OVM_ETHService(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3, OVM_ETHDeployment oVM_ETHDeployment,
        CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_ETHDeployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_ETHDeployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_ETHDeployment oVM_ETHDeployment)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_ETHDeployment>().SendRequestAsync(oVM_ETHDeployment);
    }

    public static async Task<OVM_ETHService> DeployContractAndGetServiceAsync(Web3 web3, OVM_ETHDeployment oVM_ETHDeployment,
        CancellationTokenSource cancellationTokenSource = null)
    {
        var receipt = await DeployContractAndWaitForReceiptAsync(web3, oVM_ETHDeployment, cancellationTokenSource);
        return new OVM_ETHService(web3, receipt.ContractAddress);
    }
    ...
    public Task<TransactionReceipt> FinalizeDepositRequestAndWaitForReceiptAsync(FinalizeDepositFunction finalizeDepositFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> FinalizeDepositRequestAndWaitForReceiptAsync(string to, BigInteger amount,
        CancellationTokenSource cancellationToken = null)
    {
        var finalizeDepositFunction = new FinalizeDepositFunction();
        finalizeDepositFunction.To = to;
    ...
    public Task<uint> GetFinalizeWithdrawalL1GasQueryAsync(GetFinalizeWithdrawalL1GasFunction getFinalizeWithdrawalL1GasFunction,
    ...
    public Task<TransactionReceipt> PermitRequestAndWaitForReceiptAsync(PermitFunction permitFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> PermitRequestAndWaitForReceiptAsync(string owner, string spender, BigInteger value, BigInteger deadline, byte v,
        byte[] r, byte[] s, CancellationTokenSource cancellationToken = null)
    {
        var permitFunction = new PermitFunction();
        permitFunction.Owner = owner;
        permitFunction.Spender = spender;
    ...
    public Task<TransactionReceipt> WithdrawRequestAndWaitForReceiptAsync(WithdrawFunction withdrawFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> WithdrawToRequestAndWaitForReceiptAsync(WithdrawToFunction withdrawToFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> WithdrawToRequestAndWaitForReceiptAsync(string to, BigInteger amount,
        CancellationTokenSource cancellationToken = null)
    {
        var withdrawToFunction = new WithdrawToFunction();
        withdrawToFunction.To = to;
