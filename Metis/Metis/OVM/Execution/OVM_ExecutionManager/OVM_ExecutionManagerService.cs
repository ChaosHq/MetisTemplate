...
using Metis.OVM.Execution.OVM_ExecutionManager.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Execution.OVM_ExecutionManager;

public class OVM_ExecutionManagerService
{
    public OVM_ExecutionManagerService(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3,
        OVM_ExecutionManagerDeployment oVM_ExecutionManagerDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_ExecutionManagerDeployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_ExecutionManagerDeployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_ExecutionManagerDeployment oVM_ExecutionManagerDeployment)
    {
    ...
    public static async Task<OVM_ExecutionManagerService> DeployContractAndGetServiceAsync(Web3 web3,
        OVM_ExecutionManagerDeployment oVM_ExecutionManagerDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
    ...
    public Task<BigInteger> GetMaxTransactionGasLimitQueryAsync(GetMaxTransactionGasLimitFunction getMaxTransactionGasLimitFunction,
    ...
    public Task<TransactionReceipt> OvmCALLRequestAndWaitForReceiptAsync(OvmCALLFunction ovmCALLFunction,
    ...
    public Task<TransactionReceipt> OvmCALLRequestAndWaitForReceiptAsync(BigInteger gasLimit, string address, byte[] calldata,
        CancellationTokenSource cancellationToken = null)
    {
        var ovmCALLFunction = new OvmCALLFunction();
        ovmCALLFunction.GasLimit = gasLimit;
    ...
    public Task<TransactionReceipt> OvmCREATERequestAndWaitForReceiptAsync(OvmCREATEFunction ovmCREATEFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmCREATE2RequestAndWaitForReceiptAsync(OvmCREATE2Function ovmCREATE2Function,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmCREATE2RequestAndWaitForReceiptAsync(byte[] bytecode, byte[] salt,
        CancellationTokenSource cancellationToken = null)
    {
        var ovmCREATE2Function = new OvmCREATE2Function();
        ovmCREATE2Function.Bytecode = bytecode;
    ...
    public Task<TransactionReceipt> OvmCREATEEOARequestAndWaitForReceiptAsync(OvmCREATEEOAFunction ovmCREATEEOAFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmCREATEEOARequestAndWaitForReceiptAsync(byte[] messageHash, byte v, byte[] r, byte[] s,
        CancellationTokenSource cancellationToken = null)
    {
        var ovmCREATEEOAFunction = new OvmCREATEEOAFunction();
        ovmCREATEEOAFunction.MessageHash = messageHash;
    ...
    public Task<TransactionReceipt> OvmDELEGATECALLRequestAndWaitForReceiptAsync(OvmDELEGATECALLFunction ovmDELEGATECALLFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmDELEGATECALLRequestAndWaitForReceiptAsync(BigInteger gasLimit, string address, byte[] calldata,
        CancellationTokenSource cancellationToken = null)
    {
        var ovmDELEGATECALLFunction = new OvmDELEGATECALLFunction();
        ovmDELEGATECALLFunction.GasLimit = gasLimit;
    ...
    public Task<TransactionReceipt> OvmEXTCODECOPYRequestAndWaitForReceiptAsync(OvmEXTCODECOPYFunction ovmEXTCODECOPYFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmEXTCODECOPYRequestAndWaitForReceiptAsync(string contract, BigInteger offset, BigInteger length,
        CancellationTokenSource cancellationToken = null)
    {
        var ovmEXTCODECOPYFunction = new OvmEXTCODECOPYFunction();
        ovmEXTCODECOPYFunction.Contract = contract;
    ...
    public Task<TransactionReceipt> OvmEXTCODEHASHRequestAndWaitForReceiptAsync(OvmEXTCODEHASHFunction ovmEXTCODEHASHFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmEXTCODESIZERequestAndWaitForReceiptAsync(OvmEXTCODESIZEFunction ovmEXTCODESIZEFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmGETNONCERequestAndWaitForReceiptAsync(OvmGETNONCEFunction ovmGETNONCEFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmINCREMENTNONCERequestAndWaitForReceiptAsync(OvmINCREMENTNONCEFunction ovmINCREMENTNONCEFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmREVERTRequestAndWaitForReceiptAsync(OvmREVERTFunction ovmREVERTFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmSLOADRequestAndWaitForReceiptAsync(OvmSLOADFunction ovmSLOADFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmSSTORERequestAndWaitForReceiptAsync(OvmSSTOREFunction ovmSSTOREFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmSTATICCALLRequestAndWaitForReceiptAsync(OvmSTATICCALLFunction ovmSTATICCALLFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> OvmSTATICCALLRequestAndWaitForReceiptAsync(BigInteger gasLimit, string address, byte[] calldata,
        CancellationTokenSource cancellationToken = null)
    {
        var ovmSTATICCALLFunction = new OvmSTATICCALLFunction();
        ovmSTATICCALLFunction.GasLimit = gasLimit;
    ...
    public Task<TransactionReceipt> RunRequestAndWaitForReceiptAsync(OvmTransaction transaction, string ovmStateManager,
        CancellationTokenSource cancellationToken = null)
    {
        var runFunction = new RunFunction();
        runFunction.Transaction = transaction;
    ...
    public Task<TransactionReceipt> SimulateMessageRequestAndWaitForReceiptAsync(SimulateMessageFunction simulateMessageFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> SimulateMessageRequestAndWaitForReceiptAsync(OvmTransaction transaction, string from, string ovmStateManager,
        CancellationTokenSource cancellationToken = null)
    {
        var simulateMessageFunction = new SimulateMessageFunction();
        simulateMessageFunction.Transaction = transaction;
