...
using Metis.OVM.Execution.OVM_StateManager.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Execution.OVM_StateManager;

public class OVM_StateManagerService
{
    public OVM_StateManagerService(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3, OVM_StateManagerDeployment oVM_StateManagerDeployment,
        CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_StateManagerDeployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_StateManagerDeployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_StateManagerDeployment oVM_StateManagerDeployment)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_StateManagerDeployment>().SendRequestAsync(oVM_StateManagerDeployment);
    }

    public static async Task<OVM_StateManagerService> DeployContractAndGetServiceAsync(Web3 web3,
        OVM_StateManagerDeployment oVM_StateManagerDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
    ...
    public Task<TransactionReceipt> CommitAccountRequestAndWaitForReceiptAsync(CommitAccountFunction commitAccountFunction,
    ...
    public Task<TransactionReceipt> CommitContractStorageRequestAndWaitForReceiptAsync(CommitContractStorageFunction commitContractStorageFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> CommitContractStorageRequestAndWaitForReceiptAsync(string contract, byte[] key,
        CancellationTokenSource cancellationToken = null)
    {
        var commitContractStorageFunction = new CommitContractStorageFunction();
        commitContractStorageFunction.Contract = contract;
    ...
    public Task<TransactionReceipt> CommitPendingAccountRequestAndWaitForReceiptAsync(CommitPendingAccountFunction commitPendingAccountFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> CommitPendingAccountRequestAndWaitForReceiptAsync(string address, string ethAddress, byte[] codeHash,
        CancellationTokenSource cancellationToken = null)
    {
        var commitPendingAccountFunction = new CommitPendingAccountFunction();
        commitPendingAccountFunction.Address = address;
    ...
    public Task<string> GetAccountEthAddressQueryAsync(GetAccountEthAddressFunction getAccountEthAddressFunction,
    ...
    public Task<byte[]> GetAccountStorageRootQueryAsync(GetAccountStorageRootFunction getAccountStorageRootFunction,
        BlockParameter blockParameter = null)
    {
    ...
    public Task<BigInteger> GetTotalUncommittedAccountsQueryAsync(GetTotalUncommittedAccountsFunction getTotalUncommittedAccountsFunction,
        BlockParameter blockParameter = null)
    {
    ...
    public Task<BigInteger> GetTotalUncommittedContractStorageQueryAsync(
        GetTotalUncommittedContractStorageFunction getTotalUncommittedContractStorageFunction, BlockParameter blockParameter = null)
    {
        return ContractHandler.QueryAsync<GetTotalUncommittedContractStorageFunction, BigInteger>(getTotalUncommittedContractStorageFunction,
            blockParameter);
    }
    ...
    public Task<string> IncrementTotalUncommittedAccountsRequestAsync(
        IncrementTotalUncommittedAccountsFunction incrementTotalUncommittedAccountsFunction)
    {
    ...
    public Task<TransactionReceipt> IncrementTotalUncommittedAccountsRequestAndWaitForReceiptAsync(
        IncrementTotalUncommittedAccountsFunction incrementTotalUncommittedAccountsFunction, CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<string> IncrementTotalUncommittedContractStorageRequestAsync(
        IncrementTotalUncommittedContractStorageFunction incrementTotalUncommittedContractStorageFunction)
    {
    ...
    public Task<TransactionReceipt> IncrementTotalUncommittedContractStorageRequestAndWaitForReceiptAsync(
        IncrementTotalUncommittedContractStorageFunction incrementTotalUncommittedContractStorageFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> InitPendingAccountRequestAndWaitForReceiptAsync(InitPendingAccountFunction initPendingAccountFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> PutAccountRequestAndWaitForReceiptAsync(PutAccountFunction putAccountFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> PutAccountRequestAndWaitForReceiptAsync(string address, Account account,
        CancellationTokenSource cancellationToken = null)
    {
        var putAccountFunction = new PutAccountFunction();
        putAccountFunction.Address = address;
    ...
    public Task<TransactionReceipt> PutContractStorageRequestAndWaitForReceiptAsync(PutContractStorageFunction putContractStorageFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> PutContractStorageRequestAndWaitForReceiptAsync(string contract, byte[] key, byte[] value,
        CancellationTokenSource cancellationToken = null)
    {
        var putContractStorageFunction = new PutContractStorageFunction();
        putContractStorageFunction.Contract = contract;
    ...
    public Task<TransactionReceipt> PutEmptyAccountRequestAndWaitForReceiptAsync(PutEmptyAccountFunction putEmptyAccountFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> SetAccountNonceRequestAndWaitForReceiptAsync(SetAccountNonceFunction setAccountNonceFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> SetAccountNonceRequestAndWaitForReceiptAsync(string address, BigInteger nonce,
        CancellationTokenSource cancellationToken = null)
    {
        var setAccountNonceFunction = new SetAccountNonceFunction();
        setAccountNonceFunction.Address = address;
    ...
    public Task<TransactionReceipt> SetExecutionManagerRequestAndWaitForReceiptAsync(SetExecutionManagerFunction setExecutionManagerFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> SetExecutionManagerRequestAndWaitForReceiptAsync(string ovmExecutionManager,
        CancellationTokenSource cancellationToken = null)
    {
        var setExecutionManagerFunction = new SetExecutionManagerFunction();
        setExecutionManagerFunction.OvmExecutionManager = ovmExecutionManager;
    ...
    public Task<TransactionReceipt> TestAndSetAccountChangedRequestAndWaitForReceiptAsync(
        TestAndSetAccountChangedFunction testAndSetAccountChangedFunction, CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> TestAndSetAccountChangedRequestAndWaitForReceiptAsync(string address,
        CancellationTokenSource cancellationToken = null)
    {
        var testAndSetAccountChangedFunction = new TestAndSetAccountChangedFunction();
        testAndSetAccountChangedFunction.Address = address;
    ...
    public Task<TransactionReceipt> TestAndSetAccountLoadedRequestAndWaitForReceiptAsync(
        TestAndSetAccountLoadedFunction testAndSetAccountLoadedFunction, CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> TestAndSetAccountLoadedRequestAndWaitForReceiptAsync(string address,
        CancellationTokenSource cancellationToken = null)
    {
        var testAndSetAccountLoadedFunction = new TestAndSetAccountLoadedFunction();
        testAndSetAccountLoadedFunction.Address = address;
    ...
    public Task<string> TestAndSetContractStorageChangedRequestAsync(
        TestAndSetContractStorageChangedFunction testAndSetContractStorageChangedFunction)
    {
        return ContractHandler.SendRequestAsync(testAndSetContractStorageChangedFunction);
    }

    public Task<TransactionReceipt> TestAndSetContractStorageChangedRequestAndWaitForReceiptAsync(
        TestAndSetContractStorageChangedFunction testAndSetContractStorageChangedFunction, CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> TestAndSetContractStorageChangedRequestAndWaitForReceiptAsync(string contract, byte[] key,
        CancellationTokenSource cancellationToken = null)
    {
        var testAndSetContractStorageChangedFunction = new TestAndSetContractStorageChangedFunction();
        testAndSetContractStorageChangedFunction.Contract = contract;
    ...
    public Task<TransactionReceipt> TestAndSetContractStorageLoadedRequestAndWaitForReceiptAsync(
        TestAndSetContractStorageLoadedFunction testAndSetContractStorageLoadedFunction, CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> TestAndSetContractStorageLoadedRequestAndWaitForReceiptAsync(string contract, byte[] key,
        CancellationTokenSource cancellationToken = null)
    {
        var testAndSetContractStorageLoadedFunction = new TestAndSetContractStorageLoadedFunction();
        testAndSetContractStorageLoadedFunction.Contract = contract;
    ...
    public Task<bool> WasContractStorageChangedQueryAsync(WasContractStorageChangedFunction wasContractStorageChangedFunction,
        BlockParameter blockParameter = null)
    {
    ...
    public Task<bool> WasContractStorageCommittedQueryAsync(WasContractStorageCommittedFunction wasContractStorageCommittedFunction,
        BlockParameter blockParameter = null)
    {
