...
using Metis.OVM.Chain.OVM_CanonicalTransactionChain.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Chain.OVM_CanonicalTransactionChain;

public class OVM_CanonicalTransactionChainService
{
    public OVM_CanonicalTransactionChainService(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3,
        OVM_CanonicalTransactionChainDeployment oVM_CanonicalTransactionChainDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_CanonicalTransactionChainDeployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_CanonicalTransactionChainDeployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_CanonicalTransactionChainDeployment oVM_CanonicalTransactionChainDeployment)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_CanonicalTransactionChainDeployment>()
            .SendRequestAsync(oVM_CanonicalTransactionChainDeployment);
    }

    public static async Task<OVM_CanonicalTransactionChainService> DeployContractAndGetServiceAsync(Web3 web3,
        OVM_CanonicalTransactionChainDeployment oVM_CanonicalTransactionChainDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
    ...
    public Task<BigInteger> L2_GAS_DISCOUNT_DIVISORQueryAsync(L2_GAS_DISCOUNT_DIVISORFunction l2_GAS_DISCOUNT_DIVISORFunction,
    ...
    public Task<TransactionReceipt> AppendQueueBatchRequestAndWaitForReceiptAsync(AppendQueueBatchFunction appendQueueBatchFunction,
    ...
    public Task<TransactionReceipt> AppendQueueBatchRequestAndWaitForReceiptAsync(BigInteger returnValue1,
        CancellationTokenSource cancellationToken = null)
    {
        var appendQueueBatchFunction = new AppendQueueBatchFunction();
        appendQueueBatchFunction.ReturnValue1 = returnValue1;
    ...
    public Task<TransactionReceipt> AppendSequencerBatchRequestAndWaitForReceiptAsync(AppendSequencerBatchFunction appendSequencerBatchFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> EnqueueRequestAndWaitForReceiptAsync(EnqueueFunction enqueueFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> EnqueueRequestAndWaitForReceiptAsync(string target, BigInteger gasLimit, byte[] data,
        CancellationTokenSource cancellationToken = null)
    {
        var enqueueFunction = new EnqueueFunction();
        enqueueFunction.Target = target;
    ...
    public Task<BigInteger> ForceInclusionPeriodBlocksQueryAsync(ForceInclusionPeriodBlocksFunction forceInclusionPeriodBlocksFunction,
        BlockParameter blockParameter = null)
    {
    ...
    public Task<BigInteger> ForceInclusionPeriodSecondsQueryAsync(ForceInclusionPeriodSecondsFunction forceInclusionPeriodSecondsFunction,
        BlockParameter blockParameter = null)
    {
    ...
    public Task<ulong> GetNumPendingQueueElementsQueryAsync(GetNumPendingQueueElementsFunction getNumPendingQueueElementsFunction,
        BlockParameter blockParameter = null)
    {
    ...
    public Task<GetQueueElementOutputDTO> GetQueueElementQueryAsync(GetQueueElementFunction getQueueElementFunction,
        BlockParameter blockParameter = null)
    {
        return ContractHandler.QueryDeserializingToObjectAsync<GetQueueElementFunction, GetQueueElementOutputDTO>(getQueueElementFunction,
            blockParameter);
    }
    ...
    public Task<BigInteger> MaxTransactionGasLimitQueryAsync(MaxTransactionGasLimitFunction maxTransactionGasLimitFunction,
        BlockParameter blockParameter = null)
    {
    ...
    public Task<bool> VerifyTransactionQueryAsync(OvmTransaction transaction, TransactionChainElement txChainElement, ChainBatchHeader batchHeader,
        ChainInclusionProof inclusionProof, BlockParameter blockParameter = null)
    {
