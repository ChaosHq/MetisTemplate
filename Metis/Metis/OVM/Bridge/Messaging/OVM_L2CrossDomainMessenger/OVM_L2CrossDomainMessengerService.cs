...
using Metis.OVM.Bridge.Messaging.OVM_L2CrossDomainMessenger.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Bridge.Messaging.OVM_L2CrossDomainMessenger;

public class OVM_L2CrossDomainMessengerService
{
    public OVM_L2CrossDomainMessengerService(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3,
        OVM_L2CrossDomainMessengerDeployment oVM_L2CrossDomainMessengerDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_L2CrossDomainMessengerDeployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_L2CrossDomainMessengerDeployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_L2CrossDomainMessengerDeployment oVM_L2CrossDomainMessengerDeployment)
    {
    ...
    public static async Task<OVM_L2CrossDomainMessengerService> DeployContractAndGetServiceAsync(Web3 web3,
        OVM_L2CrossDomainMessengerDeployment oVM_L2CrossDomainMessengerDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
