...
using Metis.OVM.Bridge.Messaging.OVM_L1CrossDomainMessenger.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Bridge.Messaging.OVM_L1CrossDomainMessenger;

public class OVM_L1CrossDomainMessengerService
{
    public OVM_L1CrossDomainMessengerService(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3,
        OVM_L1CrossDomainMessengerDeployment oVM_L1CrossDomainMessengerDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_L1CrossDomainMessengerDeployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_L1CrossDomainMessengerDeployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_L1CrossDomainMessengerDeployment oVM_L1CrossDomainMessengerDeployment)
    {
    ...
    public static async Task<OVM_L1CrossDomainMessengerService> DeployContractAndGetServiceAsync(Web3 web3,
        OVM_L1CrossDomainMessengerDeployment oVM_L1CrossDomainMessengerDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
    ...
    public Task<TransactionReceipt> InitializeRequestAndWaitForReceiptAsync(string libAddressManager,
        CancellationTokenSource cancellationToken = null)
    {
        var initializeFunction = new InitializeFunction();
        initializeFunction.LibAddressManager = libAddressManager;
    ...
    public Task<TransactionReceipt> RelayMessageRequestAndWaitForReceiptAsync(RelayMessageFunction relayMessageFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> RelayMessageRequestAndWaitForReceiptAsync(string target, string sender, byte[] message, BigInteger messageNonce,
        L2MessageInclusionProof proof, CancellationTokenSource cancellationToken = null)
    {
        var relayMessageFunction = new RelayMessageFunction();
        relayMessageFunction.Target = target;
        relayMessageFunction.Sender = sender;
    ...
    public Task<TransactionReceipt> ReplayMessageRequestAndWaitForReceiptAsync(ReplayMessageFunction replayMessageFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> ReplayMessageRequestAndWaitForReceiptAsync(string target, string sender, byte[] message, BigInteger messageNonce,
        uint gasLimit, CancellationTokenSource cancellationToken = null)
    {
        var replayMessageFunction = new ReplayMessageFunction();
        replayMessageFunction.Target = target;
        replayMessageFunction.Sender = sender;
    ...
    public Task<TransactionReceipt> SendMessageRequestAndWaitForReceiptAsync(SendMessageFunction sendMessageFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> SendMessageRequestAndWaitForReceiptAsync(string target, byte[] message, uint gasLimit,
        CancellationTokenSource cancellationToken = null)
    {
        var sendMessageFunction = new SendMessageFunction();
        sendMessageFunction.Target = target;
    ...
    public Task<string> XDomainMessageSenderQueryAsync(XDomainMessageSenderFunction xDomainMessageSenderFunction,
