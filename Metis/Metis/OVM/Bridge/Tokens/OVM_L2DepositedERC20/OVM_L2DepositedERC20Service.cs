...
using Metis.OVM.Bridge.Tokens.OVM_L2DepositedERC20.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Bridge.Tokens.OVM_L2DepositedERC20;

public class OVM_L2DepositedERC20Service
{
    public OVM_L2DepositedERC20Service(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3,
        OVM_L2DepositedERC20Deployment oVM_L2DepositedERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_L2DepositedERC20Deployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_L2DepositedERC20Deployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_L2DepositedERC20Deployment oVM_L2DepositedERC20Deployment)
    {
    ...
    public static async Task<OVM_L2DepositedERC20Service> DeployContractAndGetServiceAsync(Web3 web3,
        OVM_L2DepositedERC20Deployment oVM_L2DepositedERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
    {
