...
using Metis.OVM.Bridge.Tokens.OVM_L1ERC20Gateway.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Bridge.Tokens.OVM_L1ERC20Gateway;

public class OVM_L1ERC20GatewayService
{
    public OVM_L1ERC20GatewayService(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3, OVM_L1ERC20GatewayDeployment oVM_L1ERC20GatewayDeployment,
        CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_L1ERC20GatewayDeployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_L1ERC20GatewayDeployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_L1ERC20GatewayDeployment oVM_L1ERC20GatewayDeployment)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_L1ERC20GatewayDeployment>().SendRequestAsync(oVM_L1ERC20GatewayDeployment);
    }

    public static async Task<OVM_L1ERC20GatewayService> DeployContractAndGetServiceAsync(Web3 web3,
        OVM_L1ERC20GatewayDeployment oVM_L1ERC20GatewayDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
    ...
    public Task<uint> DEFAULT_FINALIZE_DEPOSIT_L2_GASQueryAsync(DEFAULT_FINALIZE_DEPOSIT_L2_GASFunction dEFAULT_FINALIZE_DEPOSIT_L2_GASFunction,
    ...
    public Task<TransactionReceipt> DepositToRequestAndWaitForReceiptAsync(string to, BigInteger amount,
        CancellationTokenSource cancellationToken = null)
    {
        var depositToFunction = new DepositToFunction();
        depositToFunction.To = to;
