...
using Metis.OVM.Verification.OVM_StateTransitioner.ContractDefinition;
using Nethereum.Contracts.ContractHandlers;
using Nethereum.RPC.Eth.DTOs;
using Nethereum.Web3;

namespace Metis.OVM.Verification.OVM_StateTransitioner;

public class OVM_StateTransitionerService
{
    public OVM_StateTransitionerService(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3,
        OVM_StateTransitionerDeployment oVM_StateTransitionerDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<OVM_StateTransitionerDeployment>()
            .SendRequestAndWaitForReceiptAsync(oVM_StateTransitionerDeployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, OVM_StateTransitionerDeployment oVM_StateTransitionerDeployment)
    {
    ...
    public static async Task<OVM_StateTransitionerService> DeployContractAndGetServiceAsync(Web3 web3,
        OVM_StateTransitionerDeployment oVM_StateTransitionerDeployment, CancellationTokenSource cancellationTokenSource = null)
    {
    ...
    public Task<TransactionReceipt> ApplyTransactionRequestAndWaitForReceiptAsync(ApplyTransactionFunction applyTransactionFunction,
    ...
    public Task<TransactionReceipt> ApplyTransactionRequestAndWaitForReceiptAsync(OvmTransaction transaction,
        CancellationTokenSource cancellationToken = null)
    {
        var applyTransactionFunction = new ApplyTransactionFunction();
        applyTransactionFunction.Transaction = transaction;
    ...
    public Task<TransactionReceipt> CommitContractStateRequestAndWaitForReceiptAsync(CommitContractStateFunction commitContractStateFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> CommitContractStateRequestAndWaitForReceiptAsync(string ovmContractAddress, byte[] stateTrieWitness,
        CancellationTokenSource cancellationToken = null)
    {
        var commitContractStateFunction = new CommitContractStateFunction();
        commitContractStateFunction.OvmContractAddress = ovmContractAddress;
    ...
    public Task<TransactionReceipt> CommitStorageSlotRequestAndWaitForReceiptAsync(CommitStorageSlotFunction commitStorageSlotFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> CommitStorageSlotRequestAndWaitForReceiptAsync(string ovmContractAddress, byte[] key, byte[] storageTrieWitness,
        CancellationTokenSource cancellationToken = null)
    {
        var commitStorageSlotFunction = new CommitStorageSlotFunction();
        commitStorageSlotFunction.OvmContractAddress = ovmContractAddress;
    ...
    public Task<TransactionReceipt> CompleteTransitionRequestAndWaitForReceiptAsync(CompleteTransitionFunction completeTransitionFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> ProveContractStateRequestAndWaitForReceiptAsync(ProveContractStateFunction proveContractStateFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> ProveContractStateRequestAndWaitForReceiptAsync(string ovmContractAddress, string ethContractAddress,
        byte[] stateTrieWitness, CancellationTokenSource cancellationToken = null)
    {
        var proveContractStateFunction = new ProveContractStateFunction();
        proveContractStateFunction.OvmContractAddress = ovmContractAddress;
        proveContractStateFunction.EthContractAddress = ethContractAddress;
    ...
    public Task<TransactionReceipt> ProveStorageSlotRequestAndWaitForReceiptAsync(ProveStorageSlotFunction proveStorageSlotFunction,
        CancellationTokenSource cancellationToken = null)
    {
    ...
    public Task<TransactionReceipt> ProveStorageSlotRequestAndWaitForReceiptAsync(string ovmContractAddress, byte[] key, byte[] storageTrieWitness,
        CancellationTokenSource cancellationToken = null)
    {
        var proveStorageSlotFunction = new ProveStorageSlotFunction();
        proveStorageSlotFunction.OvmContractAddress = ovmContractAddress;
