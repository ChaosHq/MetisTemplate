...
using Metis.OVM.Bridge.Tokens.OVM_L1ERC20Gateway;
...
public class ERC20_L1_to_L2_Deposit_and_Withdraw
{
    ...
    public async void ShouldBeAbleToDepositErc20AndWithdrawUsingTheGateway()
    {
        ...
        var erc20TokenDeployment = new ERC20Deployment {Name = tokenName, InitialSupply = 100000, Symbol = tokenSymbol, Decimals = 18};
        ...
        {
            L2DepositedERC20 = ovmL2DepositedERC20Receipt.ContractAddress, L1ERC20 = tokenDeploymentReceipt.ContractAddress,
            L1messenger = Proxy__OVM_L1CrossDomainMessenger
        };
