...
public class NFTDeploymentAndMinting
{
    ...
    public async void ShouldDeployContractCreateNftMetadataUploadToIpfsAndMint()
    {
        ...
        {
            Name = "NethereumLovesOptimism", ExternalUrl = "https://github.com/Nethereum/OptimismTemplate/",
            Image = "https://ipfs.infura.io/ipfs/" + imageNode.Id
        });
        ...
        var mintedInfo = receiptMint
            .DecodeAllEvents<TransferEventDTO>().FirstOrDefault();
        ...
        Assert.Equal("https://ipfs.infura.io/ipfs/" + imageNode.Id, nftMetadata.Image);
