using System.Linq;
using Metis;
using Metis.Libraries.Resolver.Lib_AddressManager;
using Metis.OVM.Bridge.Messaging.OVM_L1CrossDomainMessenger;
using Metis.OVM.Bridge.Messaging.OVM_L2CrossDomainMessenger;
...
using Xunit;
using SetValueFunction = OptimismTemplate.Contracts.SimpleStorage.ContractDefinition.SetValueFunction;
...
public class StorageCrossPlatformTests
{
    ...
    private readonly string ADDRESS_MANAGER = "0x3e4CFaa8730092552d9425575E49bB542e329981";
    ...
    public async void ShouldSetStorageXPlatform()
    {
        ...
        var storageServiceL1 = await SimpleStorageService.DeployContractAndGetServiceAsync(web3l1, new SimpleStorageDeployment());
        var storageServiceL2 = await SimpleStorageL2Service.DeployContractAndGetServiceAsync(web3l2, new SimpleStorageL2Deployment());
        ...
        {
            Message = new SetValueFunction {NewValue = "3e4cfaa8730092552d9425575e49bb542e329981000000000000000000000000".HexToByteArray()}
                .GetCallData(),
        ...
        var receiptMessageSent =
            await watcher.GetCrossMessageMessageTransactionReceipt(web3l1, Proxy__OVM_L1CrossDomainMessenger, messageHashes.First());
        ...
        var messageL1 = new Metis.OVM.Bridge.Messaging.OVM_L1CrossDomainMessenger.ContractDefinition.SendMessageFunction
        {
            Message = new SetValueFunction {NewValue = "3e4cfaa8730092552d9425575e49bb542e329982000000000000000000000000".HexToByteArray()}
                .GetCallData(),
