...
namespace OptimismTemplate.Contracts.L2DepositedERC20;

public class L2DepositedERC20Service
{
    public L2DepositedERC20Service(Web3 web3, string contractAddress)
    {
        Web3 = web3;
    ...
    public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Web3 web3, L2DepositedERC20Deployment l2DepositedERC20Deployment,
        CancellationTokenSource cancellationTokenSource = null)
    {
        return web3.Eth.GetContractDeploymentHandler<L2DepositedERC20Deployment>()
            .SendRequestAndWaitForReceiptAsync(l2DepositedERC20Deployment, cancellationTokenSource);
    }

    public static Task<string> DeployContractAsync(Web3 web3, L2DepositedERC20Deployment l2DepositedERC20Deployment)
    {
        return web3.Eth.GetContractDeploymentHandler<L2DepositedERC20Deployment>().SendRequestAsync(l2DepositedERC20Deployment);
    }

    public static async Task<L2DepositedERC20Service> DeployContractAndGetServiceAsync(Web3 web3,
        L2DepositedERC20Deployment l2DepositedERC20Deployment, CancellationTokenSource cancellationTokenSource = null)
    {
        var receipt = await DeployContractAndWaitForReceiptAsync(web3, l2DepositedERC20Deployment, cancellationTokenSource);
        return new L2DepositedERC20Service(web3, receipt.ContractAddress);
    }
